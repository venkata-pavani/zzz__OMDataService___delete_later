...
namespace OMSDataService.DataInterfaces
{
    public interface IContractRepository
    {
        ...
        Task<ContractDTO> GetNewContract(bool isSalesContract, bool isOffer, BidsheetSearchResult bidsheet, int? contractTypeID, int accountID);

        Task<ContractDTO> GetNewOfferFromContract(int contractNumber);

        Task<ContractDTO> GetNewPricingFromContract(int contractNumber);

        Task<ContractDTO> GetNewOfferClone(int contractNumber);

        Task<ContractDTO> GetNewContractClone(int contractNumber);
        ...
        void DeleteContract(Contract contract, ContractDetail contractDetail);
